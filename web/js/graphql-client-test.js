...
function runTests() {
    ...
    try {
        ...
        client.query(query, { projectId: 'test-project-123', limit: 50 });
    ...
    try {
        ...
        const hasAllFields = requiredFields.every(field => query.includes(field));
    ...
    (async () => {
        try {
            ...
            const result = await client.query(query, { projectId: 'test-123', limit: 50 });
